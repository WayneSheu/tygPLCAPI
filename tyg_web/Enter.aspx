<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Enter.aspx.cs" Inherits="_Default" %>
<!DOCTYPE html>
		...
		<div class="container">
			<div class="row ma_10_0">
				...
				<div class="col-sm-6 col-xs-6 txt_center">
					<div class="ma_top_10">
						<span class="fn_20">塑膠製造資訊系統</span>
					</div>
				</div>
				<div class="col-sm-3 col-xs-3"></div>
			</div>
	...
	<div id="content">
		<div class="loginpage-box">
			...
			<form class="loginform pa_20" method="post" action="Login.aspx">
                ...
                <input type="button" value="取消" class="btn l-btn-login" onclick="location.href='Default.aspx'" />
                <input type="button" value="忘記密碼" class="btn l-btn-login" onclick="window.open('http://webap11.tyg.com.tw/tygADChgPW/login.aspx', '_blank')" />
				<div class="clear"></div>
			</form>
			<!--</div>-->
		</div>
